        ...
        <div className='res-clinic d-flex justify-content-between p-3 ps-0  align-items-center pt-5' >
            <div className='d-flex flex-column gap-3' style={{ width: '60vw' }}>
                ...
                <div className='d-flex gap-3 justify-content-center '>
                    ...
                    <button className='btn btn-outline-dark p-2 w-25'> <a href={`https://www.google.com/maps/place/${encodeURIComponent(clinicAddress)}`} style={{ textDecoration: 'none', color: 'inherit' }} target="_blank" rel="noopener noreferrer">
                        Direction
                    </a></button>
                </div>
            </div>
